...
By default, DIGEST-MD5, CRAM-MD5 and NTLM methods are supported. Let's
...
![auth-simple](/assets/2015-10-22-openldap-for-ldap-plain-text-password-capture/auth-simple.png)
*auth-simple*
